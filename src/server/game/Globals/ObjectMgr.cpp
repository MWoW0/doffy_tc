...
void ObjectMgr::LoadCreatureTemplates()
{
    ...
    //                                             70          71                72               73          74
                                             "movementId, RegenHealth, mechanic_immune_mask, flags_extra, ScriptName, rewmg "
...
void ObjectMgr::LoadCreatureTemplate(Field* fields)
{
    ...
    creatureTemplate.rewardMG = fields[75].GetUInt32();
}
...
void ObjectMgr::LoadItemTemplates()
{
    ...
    //                                           134        135            136
                                             "FoodType, minMoneyLoot, maxMoneyLoot, flagsCustom, reqmg FROM item_template");
    ...
    do
    {
        ...
        itemTemplate.reqMG                   = fields[138].GetUInt32(); //used in bool Player::BuyItemFromVendorSlot
...
void ObjectMgr::LoadQuests()
{
    ...
    QueryResult result = WorldDatabase.Query("SELECT "
        ...
        //  99          100             101             102             103
        "Unknown0, ObjectiveText1, ObjectiveText2, ObjectiveText3, ObjectiveText4, rewardmg, requiredmg"
        " FROM quest_template");
    if (!result)
    {
